...
public class PizzaMemDao implements IPizzaDao{
	...
	public PizzaMemDao() {
		super();
		this.listePizza.add(new Pizza("MAR", "MARGARITA", 9.20f));
		this.listePizza.add(new Pizza("FRO", "4FROMAGES", 9.20f));
		this.listePizza.add(new Pizza("VEG", "VEGETARIENNE", 9.20f));
	}
